...
function(variant, icons)
...

  {
    ...
    description: _(
      '変愚蛮怒をブラウザで遊べます。インストールするとすべてのキー操作が利用可能になります（Firefoxではうまく動きません）。',
      'Play Hengband on your browser. When installed, full keyboard control is available (Firefox is not supported).',
    ),
    categories: ['games'],
