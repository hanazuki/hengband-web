...
const std::unordered_map<std::string_view, TerrainCharacteristics> f_info_flags = {
    ...
    { "UP_STAIRS", TerrainCharacteristics::UP_STAIRS },
    { "DOWN_STAIRS", TerrainCharacteristics::DOWN_STAIRS },
    ...
    { "STONE", TerrainCharacteristics::STONE },
    ...
    { "CAN_DISINTEGRATE", TerrainCharacteristics::CAN_DISINTEGRATE },
