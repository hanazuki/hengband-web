...
bool stasis_monster(PlayerType *player_ptr, const Direction &dir); /* Like sleep, affects undead as well */
bool stasis_evil(PlayerType *player_ptr, const Direction &dir); /* Like sleep, affects undead as well */
