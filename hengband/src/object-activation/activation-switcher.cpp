...
std::pair<bool, std::shared_ptr<ItemEntity>> switch_activation(PlayerType *player_ptr, ItemEntity &item, const RandomArtActType index, std::string_view name)
{
    ...
    case RandomArtActType::SUNLIGHT:
        return { activate_sunlight(player_ptr), nullptr };
    case RandomArtActType::BO_MISS_1:
        return { activate_missile_1(player_ptr), nullptr };
    case RandomArtActType::BA_POIS_1:
        return { activate_ball_pois_1(player_ptr), nullptr };
    case RandomArtActType::BO_ELEC_1:
        return { activate_bolt_elec_1(player_ptr), nullptr };
    case RandomArtActType::BO_ACID_1:
        return { activate_bolt_acid_1(player_ptr), nullptr };
    case RandomArtActType::BO_COLD_1:
        return { activate_bolt_cold_1(player_ptr), nullptr };
    case RandomArtActType::BO_FIRE_1:
        return { activate_bolt_fire_1(player_ptr), nullptr };
    case RandomArtActType::BA_COLD_1:
        return { activate_ball_cold_1(player_ptr), nullptr };
    ...
    case RandomArtActType::BA_FIRE_2:
        return { activate_ball_fire_2(player_ptr, name), nullptr };
    case RandomArtActType::BA_FIRE_3:
        return { activate_ball_fire_3(player_ptr), nullptr };
    case RandomArtActType::BA_FIRE_4:
        return { activate_ball_fire_4(player_ptr), nullptr };
    case RandomArtActType::BA_ELEC_2:
        return { activate_ball_elec_2(player_ptr), nullptr };
    case RandomArtActType::BA_ELEC_3:
        return { activate_ball_elec_3(player_ptr), nullptr };
    case RandomArtActType::BA_ACID_1:
        return { activate_ball_acid_1(player_ptr), nullptr };
    case RandomArtActType::BA_NUKE_1:
        return { activate_ball_nuke_1(player_ptr), nullptr };
    case RandomArtActType::HYPODYNAMIA_1:
        return { activate_bolt_hypodynamia_1(player_ptr, name), nullptr };
    case RandomArtActType::HYPODYNAMIA_2:
        return { activate_bolt_hypodynamia_2(player_ptr), nullptr };
    case RandomArtActType::DRAIN_1:
        return { activate_bolt_drain_1(player_ptr), nullptr };
    case RandomArtActType::BO_MISS_2:
        return { activate_missile_2(player_ptr), nullptr };
    case RandomArtActType::WHIRLWIND:
        return { activate_whirlwind(player_ptr), nullptr };
    case RandomArtActType::DRAIN_2:
        return { activate_bolt_drain_2(player_ptr), nullptr };
    case RandomArtActType::CALL_CHAOS:
        return { activate_call_chaos(player_ptr), nullptr };
    case RandomArtActType::ROCKET:
        return { activate_rocket(player_ptr), nullptr };
    case RandomArtActType::DISP_EVIL:
        return { activate_dispel_evil(player_ptr), nullptr };
    case RandomArtActType::BA_MISS_3:
        return { activate_missile_3(player_ptr), nullptr };
    case RandomArtActType::DISP_GOOD:
        return { activate_dispel_good(player_ptr), nullptr };
    case RandomArtActType::BO_MANA:
        return { activate_bolt_mana(player_ptr, name), nullptr };
    case RandomArtActType::BA_WATER:
        return { activate_ball_water(player_ptr, name), nullptr };
    case RandomArtActType::BA_DARK:
        return { activate_ball_dark(player_ptr, name), nullptr };
    case RandomArtActType::BA_MANA:
        return { activate_ball_mana(player_ptr, name), nullptr };
    case RandomArtActType::PESTICIDE:
        return { activate_pesticide(player_ptr), nullptr };
    case RandomArtActType::BLINDING_LIGHT:
        return { activate_blinding_light(player_ptr, name), nullptr };
    case RandomArtActType::BIZARRE:
        return { activate_ring_of_power(player_ptr, name), nullptr };
    case RandomArtActType::CAST_BA_STAR:
        return { activate_ball_lite(player_ptr, name), nullptr };
    case RandomArtActType::BLADETURNER:
        return { activate_bladeturner(player_ptr), nullptr };
    case RandomArtActType::BR_FIRE:
        return { activate_breath_fire(player_ptr, item), nullptr };
    case RandomArtActType::BR_COLD:
        return { activate_breath_cold(player_ptr, item), nullptr };
    case RandomArtActType::BR_DRAGON:
        return { activate_dragon_breath(player_ptr, item), nullptr };
    case RandomArtActType::TREE_CREATION:
        return { activate_tree_creation(player_ptr, item, name), nullptr };
    case RandomArtActType::ANIM_DEAD:
        return { activate_animate_dead(player_ptr, item), nullptr };
    case RandomArtActType::CONFUSE:
        return { activate_confusion(player_ptr), nullptr };
    case RandomArtActType::SLEEP:
        return { activate_sleep(player_ptr), nullptr };
    case RandomArtActType::QUAKE:
        return { activate_earthquake(player_ptr), nullptr };
    case RandomArtActType::TERROR:
        return { activate_terror(player_ptr), nullptr };
    case RandomArtActType::TELE_AWAY:
        return { activate_teleport_away(player_ptr), nullptr };
    case RandomArtActType::BANISH_EVIL:
        return { activate_banish_evil(player_ptr), nullptr };
    case RandomArtActType::GENOCIDE:
        return { activate_genocide(player_ptr), nullptr };
    case RandomArtActType::MASS_GENO:
        return { activate_mass_genocide(player_ptr), nullptr };
    case RandomArtActType::SCARE_AREA:
        return { activate_scare(player_ptr), nullptr };
    case RandomArtActType::AGGRAVATE:
        return { activate_aggravation(player_ptr, item, name), nullptr };
    case RandomArtActType::CHARM_ANIMAL:
        return { activate_charm_animal(player_ptr), nullptr };
    case RandomArtActType::CHARM_UNDEAD:
        return { activate_charm_undead(player_ptr), nullptr };
    case RandomArtActType::CHARM_OTHER:
        return { activate_charm_other(player_ptr), nullptr };
    case RandomArtActType::CHARM_ANIMALS:
        return { activate_charm_animals(player_ptr), nullptr };
    case RandomArtActType::CHARM_OTHERS:
        return { activate_charm_others(player_ptr), nullptr };
    ...
    case RandomArtActType::SUMMON_ELEMENTAL:
        return { cast_summon_elemental(player_ptr, (player_ptr->lev * 3) / 2), nullptr };
    case RandomArtActType::SUMMON_DEMON:
        cast_summon_demon(player_ptr, (player_ptr->lev * 3) / 2);
        return { true, nullptr };
    case RandomArtActType::SUMMON_UNDEAD:
        return { cast_summon_undead(player_ptr, (player_ptr->lev * 3) / 2), nullptr };
    case RandomArtActType::SUMMON_HOUND:
        return { cast_summon_hound(player_ptr, (player_ptr->lev * 3) / 2), nullptr };
    ...
    case RandomArtActType::SUMMON_OCTOPUS:
        return { cast_summon_octopus(player_ptr), nullptr };
    ...
    case RandomArtActType::CURE_LW:
        return { activate_cure_lw(player_ptr), nullptr };
    ...
    case RandomArtActType::RESIST_ALL:
        return { activate_resistance_elements(player_ptr), nullptr };
    ...
    case RandomArtActType::ACID_BALL_AND_RESISTANCE:
        return { activate_acid_ball_and_resistance(player_ptr, name), nullptr };
    case RandomArtActType::FIRE_BALL_AND_RESISTANCE:
        return { activate_fire_ball_and_resistance(player_ptr, name), nullptr };
    case RandomArtActType::COLD_BALL_AND_RESISTANCE:
        return { activate_cold_ball_and_resistance(player_ptr, name), nullptr };
    case RandomArtActType::ELEC_BALL_AND_RESISTANCE:
        return { activate_elec_ball_and_resistance(player_ptr, name), nullptr };
    case RandomArtActType::POIS_BALL_AND_RESISTANCE:
        return { activate_pois_ball_and_resistance(player_ptr, name), nullptr };
    case RandomArtActType::RESIST_ACID:
        return { activate_resistance_acid(player_ptr, name), nullptr };
    case RandomArtActType::RESIST_FIRE:
        return { activate_resistance_fire(player_ptr, name), nullptr };
    case RandomArtActType::RESIST_COLD:
        return { activate_resistance_cold(player_ptr, name), nullptr };
    case RandomArtActType::RESIST_ELEC:
        return { activate_resistance_elec(player_ptr, name), nullptr };
    ...
    case RandomArtActType::DETECT_ALL:
        return { activate_all_detection(player_ptr), nullptr };
    case RandomArtActType::DETECT_XTRA:
        return { activate_extra_detection(player_ptr), nullptr };
    case RandomArtActType::ID_FULL:
        return { activate_fully_identification(player_ptr), nullptr };
    case RandomArtActType::ID_PLAIN:
        return { activate_identification(player_ptr), nullptr };
    case RandomArtActType::RUNE_EXPLO:
        return { activate_exploding_rune(player_ptr), nullptr };
    case RandomArtActType::RUNE_PROT:
        return { activate_protection_rune(player_ptr), nullptr };
    case RandomArtActType::SATIATE:
        (void)set_food(player_ptr, PY_FOOD_MAX - 1);
        return { true, nullptr };
    case RandomArtActType::DEST_DOOR:
        return { activate_door_destroy(player_ptr), nullptr };
    case RandomArtActType::STONE_MUD:
        return { activate_stone_mud(player_ptr), nullptr };
    case RandomArtActType::RECHARGE:
        return { activate_recharge(player_ptr), nullptr };
    ...
    case RandomArtActType::DIM_DOOR:
        return { activate_dimension_door(player_ptr), nullptr };
    case RandomArtActType::TELEPORT:
        return { activate_teleport(player_ptr), nullptr };
    case RandomArtActType::RECALL:
        return { activate_recall(player_ptr), nullptr };
    case RandomArtActType::JUDGE:
        return { activate_judgement(player_ptr, name), nullptr };
    case RandomArtActType::TELEKINESIS:
        return { activate_telekinesis(player_ptr, name), nullptr };
    case RandomArtActType::DETECT_UNIQUE:
        return { activate_unique_detection(player_ptr), nullptr };
    case RandomArtActType::ESCAPE:
        return { activate_escape(player_ptr), nullptr };
    ...
    case RandomArtActType::RECHARGE_XTRA:
        return { activate_recharge_extra(player_ptr, name), nullptr };
    case RandomArtActType::LORE:
        return { StoneOfLore(player_ptr).perilous_secrets(), nullptr };
    case RandomArtActType::SHIKOFUMI:
        return { activate_shikofumi(player_ptr), nullptr };
    case RandomArtActType::PHASE_DOOR:
        return { activate_phase_door(player_ptr), nullptr };
    case RandomArtActType::DETECT_ALL_MONS:
        return { activate_all_monsters_detection(player_ptr), nullptr };
    case RandomArtActType::ULTIMATE_RESIST:
        return { activate_ultimate_resistance(player_ptr), nullptr };
    case RandomArtActType::ELBERETH:
        return { activate_protection_elbereth(player_ptr), nullptr };
    case RandomArtActType::DETECT_TREASURE:
        return { activate_detect_treasure(player_ptr), nullptr };
    case RandomArtActType::CAST_OFF:
        if (const auto item_casted = cosmic_cast_off(player_ptr, item); item_casted) {
            return { true, item_casted };
        }

        return { false, nullptr };
    case RandomArtActType::FALLING_STAR:
        return { activate_toragoroshi(player_ptr), nullptr };
    case RandomArtActType::GRAND_CROSS:
        return { activate_grand_cross(player_ptr), nullptr };
    ...
    case RandomArtActType::FISHING:
        return { fishing(player_ptr), nullptr };
    case RandomArtActType::INROU:
        mitokohmon(player_ptr);
        return { true, nullptr };
    case RandomArtActType::MURAMASA:
        return { activate_muramasa(player_ptr, item), nullptr };
    case RandomArtActType::BLOODY_MOON:
        return { activate_bloody_moon(player_ptr, item), nullptr };
    case RandomArtActType::CRIMSON:
        return { activate_crimson(player_ptr, item), nullptr };
    case RandomArtActType::HERO_BLESS:
        (void)set_hero(player_ptr, randint1(25) + 25, false);
        (void)set_blessed(player_ptr, randint1(25) + 25, true);
        return { true, nullptr };
    case RandomArtActType::CREATE_AMMO:
        return { activate_create_ammo(player_ptr), nullptr };
    case RandomArtActType::DISPEL_MAGIC:
        return { activate_dispel_magic(player_ptr), nullptr };
    case RandomArtActType::WHISTLE:
        return { activate_whistle(player_ptr, item), nullptr };
    case RandomArtActType::CAPTURE_MONSTER:
        return { exe_monster_capture(player_ptr, item), nullptr };
    default:
